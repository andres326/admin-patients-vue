...
<template>
  <div class="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
    ...
    <p class="font-bold mb-3 text-gray-700 uppercase">Clearance Date:
      <span class="font-normal normal-case">
    ...
    <div class="grid md:grid-cols-2  gap-5 mt-10 ">
      ...
      <button type="button"
        class="block w-full py-2 px-10 bg-red-600 hover:bg-red-700 text-white font-bold uppercase rounded-lg">Delete</button>
    </div>
  </div>
</template>